...
const LoginScreen = ({ navigation, setIsAuthenticated }) => {
  ...
  const [errorMessage, setErrorMessage] = useState(''); // Adicionando estado para a mensagem de erro

  const handleLogin = async () => {
    setErrorMessage(''); // Resetando a mensagem de erro antes de iniciar a verificação
